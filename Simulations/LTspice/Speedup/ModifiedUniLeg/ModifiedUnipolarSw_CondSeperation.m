% LTspice to matlab
ModifiedUnipolar_UJ4C075018K4S_DeadTimeLeg = LTspice2Matlab('ModifiedUnipolar_UJ4C075018K4S_DeadTimeLeg.raw',...
    [7 21 22 24 43 48 58 61 65 69 73],5); 
Vdc = 400;
Tsw = 1/50e3;

%% Array Definition
% High Freq
t = ModifiedUnipolar_UJ4C075018K4S_DeadTimeLeg.time_vect;
Vsw_DS = ModifiedUnipolar_UJ4C075018K4S_DeadTimeLeg.variable_mat(1,:)-...
    ModifiedUnipolar_UJ4C075018K4S_DeadTimeLeg.variable_mat(2,:);
Isw_S = ModifiedUnipolar_UJ4C075018K4S_DeadTimeLeg.variable_mat(8,:);
%% Array Definition
% Low Freq
t = ModifiedUnipolar_UJ4C075018K4S_DeadTimeLeg.time_vect;
Vsw_DS = ModifiedUnipolar_UJ4C075018K4S_DeadTimeLeg.variable_mat(3,:);
Isw_S = ModifiedUnipolar_UJ4C075018K4S_DeadTimeLeg.variable_mat(11,:);
