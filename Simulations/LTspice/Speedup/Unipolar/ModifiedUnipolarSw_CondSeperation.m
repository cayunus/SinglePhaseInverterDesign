% LTspice to matlab
Unipolar_UJ4C075018K4S_DeadTime = LTspice2Matlab('Unipolar_UJ4C075018K4S_DeadTime.raw',...
    [19 20 21 23 42 47 56 59 63 67 71],5);
% 19-Vdc 20-Va 21-Vout- 23-Vout+ 42-IL1 47-IRload1 56-Ivdc 59-Isw1 63-Isw2
% 67-Isw3 71-Isw4
Vdc = 400;
Tsw = 1/50e3;
...
%% Array Definition
% High Freq
t = Unipolar_UJ4C075018K4S_DeadTime.time_vect;
Vsw_DS = Unipolar_UJ4C075018K4S_DeadTime.variable_mat(1,:)-...
    Unipolar_UJ4C075018K4S_DeadTime.variable_mat(2,:);
Isw_S = Unipolar_UJ4C075018K4S_DeadTime.variable_mat(8,:);
%% Array Definition
% Low Freq
t = Unipolar_UJ4C075018K4S_DeadTime.time_vect;
Vsw_DS = Unipolar_UJ4C075018K4S_DeadTime.variable_mat(3,:);
Isw_S = Unipolar_UJ4C075018K4S_DeadTime.variable_mat(11,:);
